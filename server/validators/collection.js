...
const CollectionValidationSchema = Yup.object().shape({
  ...
  license: Yup.string().oneOf(["CC-BY-NC-SA","CC BY-SA"],"Debe proporcionarse un tipo de licencia valida: CC-BY-NC-SA o CC BY-SA")
})
...
export default async (req, res, next) => {
    ...
    // Get collections
        let languagesDocs = await Language.find({"_id":{
            $in : languages
