        ...
        <div class="container">
            <div class="col-sm-12" id="contenedor_items_cabezal_audioanotaciones">
                <div class="" id="contenedor_titulos_cabezal_audioanotaciones">
                    ...
                    <h4 class="etiqueta_nombre_coleccion_audioanotaciones" id="etiqueta_coleccion_audioanotaciones">
                        De la colección
                    </h4>
                    <!--NOMBRE DE LA COLECCIÓN EN ENCABEZADO-->
                    <h3 class="nombre_coleccion_audioanotaciones blanco">
                        {{collectionName}}
                        <button class="btn_info_coleccion_cabezal_coleccion_audioanotaciones" id="coleccion_info_general_cabezal">
                            <span  @click="showCollection(collectionName, languageGroupName,languageGroupId)" class="icono_info_coleccion_audioanotacion icon-info1"></span>
                        </button>
                    </h3>
                    <h4 class="blanco gpo_lenguas_audioanotaciones">
                        Grupo de lenguas:
                        <strong>{{languageGroupName}}
                            <span class="gpo_lenguas_glottocode_info">{{languageGroupId}}</span></strong>
                    </h4>
                </div>
                <div class="" id="contenedor_botones_cabezal">
                    ...
                    <button onclick="window.location.href = '/audioannotations/create'" class="btn btn-primario">
            ...
            <div class="contenedor_tabla_mis_colecciones">
                    ...
                    <thead>
                        <th class="cabezal_columnas_th" id="th_acciones_generales">
                            <div class="contenedor_acciones_generales">
                                ...
                                <button class="btn-eliminar_seleccionados prueba">
                                    <span class="icono_boton_eliminar_audioanotaciones icon-delete"></span>
                                </button>
                            </div>
                        </th>
                        <th class="cabezal_columnas_th" id="th_titulo_por_audioanotacion">
                            <div class="contenedor_etiquetas_barras_busqueda">
                                ...
                                <button id="titulo_on" @click="ordenar_ascendente('titulo_on')" class="flecha_orden_ascendente">
                        ...
                        <th class="cabezal_columnas_th">
                            <div class="contenedor_etiquetas_barras_busqueda">
                                ...
                                <button id="lengua_on" @click="ordenar_ascendente('lengua_on')" class="flecha_orden_ascendente active">
                                    <span class="icon-arrow-up"></span>
                                </button>
                                <button id="lengua_off" @click="ordenar_descendente('lengua_off')" class="flecha_orden_descendente">
                                    <span class="icon-arrow-down"></span>
                                </button>
                            </div>
                        ...
                        <th class="cabezal_columnas_th">
                            <div class="contenedor_etiquetas_barras_busqueda">
                                ...
                                <button id="comunidad_on" @click="ordenar_ascendente('comunidad_on')" class="flecha_orden_ascendente">
                                    <span class="icon-arrow-up"></span>
                                </button>
                                <button id="comunidad_off" @click="ordenar_descendente('comunidad_off')" class="flecha_orden_descendente">
                                    <span class="icon-arrow-down"></span>
                                </button>
                            </div>
                        ...
                        <th class="cabezal_columnas_th" id="th_hablantes">
                            <div class="contenedor_etiquetas_barras_busqueda">
                                ...
                                <button id="hablantes_on" @click="ordenar_ascendente('hablantes_on')" class="flecha_orden_ascendente">
                                    <span class="icon-arrow-up"></span>
                                </button>
                                <button id="hablantes_off" @click="ordenar_descendente('hablantes_off')" class="flecha_orden_descendente">
                                    <span class="icon-arrow-down"></span>
                                </button>
                            </div>
                        ...
                        <th class="cabezal_columnas_th">
                            <div class="contenedor_etiquetas_barras_busqueda">
                                ...
                                <button id="genero_on" @click="ordenar_ascendente('genero_on')" class="flecha_orden_ascendente">
                                    <span class="icon-arrow-up"></span>
                                </button>
                                <button id="genero_off" @click="ordenar_descendente('genero_off')" class="flecha_orden_descendente">
                                    <span class="icon-arrow-down"></span>
                                </button>
                            </div>
                        ...
                        <th class="contenedor_btn_regresar_th" id="th_acciones">
                            <div class="contenedor_boton_accion_cabeza_tabla_audioanotaciones">
                                <button class="btn-regresar_audioanotaciones" id="btn-regresar_audioanotaciones">
                                    <span onclick="window.location.href = '/collections'" class="icono_boton_eliminar_audioanotaciones icon-back">
                                        <!--TODO AQUI---></span>
                                </button>
                            </div>
                        </th>
                    ...
                    <tbody v-for="(item2, index) in search_titulo" :key="'item' + index">
                        <tr>
                            ...
                            <td class="titulo_audioanotacion_tabla" data-label="titulo">
                                ...
                                <!--<i>(Malvaceae: Guazuma ulmifolia Lam. var.  ulmifolia)</i>--><span class="unique_id" data-label="unique_id">UID:xxx xxxxxxx xx</span>
                            </td>
                    ...
                    item2.location.Nom_Ent
                            ...
                            <td class="td_acciones">
                                <div class="contenedor_botones_accion">
                                    <button aria-hidden="true" class="btn_accion_tabla" id="coleccion_info" @click="showAudio(item2.title, item2.description)">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="contenedor_opciones_elipsis">
                                            <a v-bind:href="'/audioannotations/vuetest/' + item2._id" class="btn_opciones_ellipsis_mis_colecciones"><span class="icono_opcion_elipsis icon-file_upload"></span>
                                                Reproducir Audioanotación</a>
                                            <a v-bind:href="'/audioannotations/edit/' + item2._id" class="btn_opciones_ellipsis_mis_colecciones"><span class="icono_opcion_elipsis icon-edit"></span>
                ...
                <div class="contenedor_paginacion">
                    <div class="contenedor_input_paginacion">
                        <input class="" id="busqueda_paginacion" v-model="pagina_buscar" type="text" placeholder="Pag." />
                        <button class="btn_lateral_input" for="busqueda_paginacion" @click="getPage(pagina_buscar)">
                            <span class="icono_pagina_busqueda icon-chevron-right"></span>
                        </button>
                    </div>
                    <div class="contenedor_numeros_paginacion">
                        <a v-if="paginacion.hasPrevPage" class="icono_paginacion" href="#" @click.prevent="getPage(1)"><span v-if="paginacion.hasPrevPage" class="icon-first_page"></span></a>
                        <a v-if="paginacion.hasPrevPage" class="icono_paginacion" href="#" @click.prevent="getPage(pagina.prev)"><span v-if="paginacion.hasPrevPage" class="icon-angle-left"></span></a>
                        <a v-for="(pag, index) in pagesNumber" :key="index" v-bind:class="[
                  pag == isActived
                    ? 'numero_paginacion active'
                    : 'numero_paginacion',
                ]" href="#" @click.prevent="getPage(pag)">{{ pag }}</a>

                        <!--<a v-if="paginacion.hasNextPage" class="ultima_pagina" href="#" @click.prevent="getPage(pagina.pageCount)"
                >...{{ paginacion.pageCount }}</a
              >-->
                        <a class="icono_paginacion" href="#" @click.prevent="getPage(pagina.next)"><span v-if="paginacion.hasNextPage" class="icon-angle-right"></span></a>
                        <a v-if="paginacion.hasNextPage" class="icono_paginacion" href="#" @click.prevent="getPage(pagina.pageCount)"><span v-if="paginacion.hasNextPage" class="icon-last_page"></span></a>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        showCollection(collectionName,languageGroupName,languageGroupId){
          this.$swal({
                title: collectionName,
                text: languageGroupName,languageGroupId,
                showCloseButton: true,
            })
        },
