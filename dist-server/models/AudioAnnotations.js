...
eaf:String,titulo:String,description:String,genero:String,duracion:String,mp3_url:String,//location: { type: Schema.ObjectId, ref:"Locations" },
location:String,colection:{type:_mongoose.Schema.ObjectId,ref:"Collection"},//glottolog:{type:Schema.ObjectId,ref:"Glottologs"},
gid:String,//cambiar por L_gid
siglas:String,user:{type:_mongoose.Schema.Types.ObjectId,ref:"Users"},TIER:[{TIER_ID:String,type:String,participant:String,Display:String,color:String}]});//AudioAnnotationsSchema.methods.updateCollection= async function(data){
