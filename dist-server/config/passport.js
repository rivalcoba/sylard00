...
// MATCH USER
_User["default"].findOne({email:a}).then(function(a){return a?(console.log("--------------------------"),console.log("> CUENTA ".concat(a.emailConfirmedAt?"ACTIVA":"INACTIVA")),console.log("--------------------------"),a.emailConfirmedAt?void// MATCH PASSWORD
