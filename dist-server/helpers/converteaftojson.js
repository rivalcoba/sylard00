...
}function _default(){let a=_path.default.join(__dirname,"..","public","eaf","asset01.eaf");console.log(a),console.log("Aqui esta el error");let b="";try{b=_fs.default.readFileSync(_path.default.join(__dirname,"..","public","eaf","asset01.eaf"))}catch(a){console.trace(a)}//const xml = fs.readFileSync('../public/eaf/asset01.eaf-1603583874596.eaf');
// convert XML to JSON
...
// save JSON in a file
const p=JSON.stringify(obj,null,4);// path.join(__dirname,'..','public','eaf','eaf.json')  
