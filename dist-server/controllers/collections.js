...
const c=await _Glottolog.default.find({},"gid name parent_id").exec();let d=c.map(a=>{let b={};return b=a.toJSON(),b});b.render("collections/create",{languages:d})},addCollection=async(a,b)=>{// Grab collections from body
