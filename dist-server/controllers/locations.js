...
// Helpers
const index=(a,b)=>{b.render("locations/index")},indexNomLoc=async(a,b)=>{console.log(`> Nomloc: ${a.params.nom_loc}`);let{nom_loc:c}=a.params;c=_regexhelp.default.diacriticSensitiveRegex(c),console.log(`> Regex: ${c}`);var d=new RegExp(c,"i");const e=await _Location.default.find({Nom_Loc:d}).limit(20).exec();let f=e.map(a=>a.toJSON());return b.json(f);// List all the collections
//   res.json({
//     'Mapa': '010010144',
//     'Cve_Ent': '01',
